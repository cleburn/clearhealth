    ...
    <Card className="overflow-hidden">
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500">Doctor ID: {note.doctorId.slice(0, 8)}...</p>
          </div>
        </div>
      ...
      {isExpanded && (
        <div className="mt-4 space-y-4 border-t pt-4">
          <div>
            <h4 className="text-xs font-semibold uppercase tracking-wider text-gray-500">Subjective</h4>
            <p className="mt-1 text-sm text-gray-700">{note.subjective}</p>
          </div>
          <div>
            <h4 className="text-xs font-semibold uppercase tracking-wider text-gray-500">Objective</h4>
            <p className="mt-1 text-sm text-gray-700">{note.objective}</p>
          </div>
          <div>
            <h4 className="text-xs font-semibold uppercase tracking-wider text-gray-500">Assessment</h4>
            <p className="mt-1 text-sm text-gray-700">{note.assessment}</p>
          </div>
          <div>
            <h4 className="text-xs font-semibold uppercase tracking-wider text-gray-500">Plan</h4>
