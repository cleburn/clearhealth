...
describe('Appointment Routes', () => {
  ...
  beforeEach(() => {
    ...
    mockPrisma.appointment.create.mockResolvedValue({
      id: 'appt-new-001', tenantId: 'tenant-test-001', patientId: SYNTHETIC_PATIENT_ID,
      doctorId: SYNTHETIC_DOCTOR_ID, scheduledAt: new Date(), duration: 30,
      status: 'SCHEDULED', type: 'FOLLOW_UP', notes: null,
      createdAt: new Date(), updatedAt: new Date(),
    });
    mockPrisma.appointment.update.mockResolvedValue({
      id: SYNTHETIC_APPOINTMENT_ID, tenantId: 'tenant-test-001', status: 'CONFIRMED',
      createdAt: new Date(), updatedAt: new Date(),
    });
